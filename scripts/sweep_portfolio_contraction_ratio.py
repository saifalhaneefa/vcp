"""Portfolio sensitivity analysis for the progressive contraction ratio.

Does not change the baseline configuration. Runs the full portfolio backtest at
several contraction-ratio values.

Run:
    python scripts/sweep_portfolio_contraction_ratio.py
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Comma-separated max_contraction_ratio values.",
    )
    ...
    print("=" * 100)
    print("PORTFOLIO CONTRACTION RATIO SENSITIVITY")
    print("=" * 100)
    print(f"Period: {args.start} -> {args.end}")
    print(f"Symbols: {len(data)}")
    print(f"Baseline ratio: {base.vcp.max_contraction_ratio}")
    ...
    path = out / "portfolio_contraction_ratio_sensitivity.csv"
